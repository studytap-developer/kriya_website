...
//   {
//     value: "5.55",
//     label: "Plain 22kt Jewellery",
//     color: "from-amber-400 to-yellow-500",
//   },
//   {
//     value: "9.55",
//     label: "Design & Stone Jewellery",
//     color: "from-rose-400 to-pink-500",
//   },
//   {
//     value: "11.55",
//     label: "Exclusive Jewellery",
//     color: "from-purple-400 to-indigo-500",
//   },
//   {
//     value: "30",
//     label: "18kt Gold & LGD Jewellery",
...
//       const landedIndex =
//         (parts.length - Math.floor((finalDeg % 360) / anglePerItem)) %
//         parts.length;
...
//       await fetch(
//         "https://script.google.com/macros/s/AKfycbxPcow1fQwF3eV9D8Pj4rG9xQUkDXZyYXWmV_fXPqHCKJWZpvXOo9r1P3Li5Jtw5mUv/exec",
//         {
//           method: "POST",
//           body: formData,
//         }
...
//                 <p className="text-yellow-200 text-sm font-semibold leading-tight">
//                   Aashadam, Shravanam & 1st Anniversary
//                 </p>
...
//                             >
//                               <div className="text-white/90 text-xs font-medium leading-tight drop-shadow">
//                                 FLAT VA *
//                               </div>
...
//                   <div className="w-0 h-0 border-l-[12px] border-r-[12px] border-b-[50px] border-l-transparent border-r-transparent border-b-red-600 drop-shadow-lg" />
//                   <div className="absolute top-10 left-1/2 -translate-x-1/2 w-5 h-5 bg-red-600 rounded-full border-2 border-white shadow-lg" />
//                 </div>
//               </div>
//             </div>
...
//                 <Gift
//                   className={`w-5 h-5 ${
//                     isSpinning ? "animate-spin" : "group-hover:animate-bounce"
//                   }`}
//                 />
...
//                   <p className="font-medium">✨ No Making Charges</p>
//                   <p className="text-xs mt-1">
//                     Valid from 01-07-2025 to 20-08-2025
//                   </p>
//                 </div>
//               </div>
//             </div>
...
//                 className="group bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-white font-bold py-4 px-6 rounded-xl shadow-xl transition-all duration-300 transform active:scale-95 w-full"
//               >
...
//                   onClick={handleClaim}
//                   disabled={!phone.trim()}
//                   className="w-full bg-gradient-to-r from-green-600 to-emerald-600 hover:from-green-700 hover:to-emerald-700 text-white font-bold py-4 px-6 rounded-lg shadow-lg transition-all duration-300"
//                 >
//                   Submit & Claim Offer
//                 </button>
//               </div>
