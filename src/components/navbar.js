...
// import kriyalogo from '../assets/kriyalogo.png'; // Ensure the path to your logo is correct
...
const Navbar = () => {
  ...
  return (
    <>
      <nav className="bg-[#5d3a29] border-b border-gray-200 px-4  sm:px-6 lg:px-8 sticky top-0 z-50">
        <div className="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
          {/* Logo Section */}
          <a href="/" className="flex items-center">
            <img src={kriyalogo} alt="Kriya Logo" className="h-20 w-"  />
          </a>
